...
Тепер давайте додамо ще один клас, який реалізує інтерфейс Printable:
...
Мі отримаємо помилку оскільки Spring не знає, яку із двох реалізацій Printable вибрати:
...
Створіть ієрархую класів, які разом слугуються для досягнення однієї цілі. Для складання системи воєдино використайте DI.
